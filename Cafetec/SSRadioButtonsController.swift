...
class SSRadioButtonsController : NSObject
{
    ...
    /**
     Variadic parameter init that accepts UIButtons.
     - parameter buttons: Array of Buttons that should behave as Radio Buttons
     */
    init(buttons: [UIButton]) {
        super.init()
        for aButton in buttons {
    ...
    /*
    Remove all the buttons in the controller
    */
    func removeAll(){
        buttonsArray.removeAll()
    }
    /*Print all the buttons in the controller, and count them*/
    func printButtonsArray(){
